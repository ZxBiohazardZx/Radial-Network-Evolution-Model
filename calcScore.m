...
%
function [Score,UserBen,OperCosts,Ridership,TTT_New] = calcScore(Candidate,CurCosts,ODMatrix,MinTravelDist,VMode,VAlt,Alpha,VOT,LBeta)
    ...
    [TTT_New,Ridership,DeltaTT]=calcUserBenefits(Candidate,CurCosts,ODMatrix,MinTravelDist,VMode,VAlt,LBeta);
...
function [TTT_New,Ridership,DeltaTT] = calcUserBenefits(Candidate,CurCosts,ODMatrix,MinTravelDist,VMode,VAlt,LBeta)
